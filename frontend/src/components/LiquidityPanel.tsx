      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-6 space-y-4">
        ...
        {liqMode === "add" && (
          <>
            ...
            <input
              ...
              className="w-full bg-[var(--bg-elevated)] border border-[var(--border)] rounded-xl px-4 py-3 text-xl outline-none text-[var(--text)]"
            />
            ...
            {/* Sequential approve: token0 → token1 → Add */}
        ...
        {liqMode === "remove" && (
          <>
            ...
            >
              {isPending || isConfirming ? "Confirming..." : `Remove Liquidity · ${swapPair}`}
            </button>
          </>
        )}
