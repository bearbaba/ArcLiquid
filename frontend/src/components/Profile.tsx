  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] px-5 py-5 space-y-3">
                ...
                {!editing ? (
                  ...
                  <div className="flex gap-2 w-full">
                    <input
                      ...
                      className="field-input flex-1 px-3 py-1.5 text-sm outline-none"
                      autoFocus
                    />
                    <button
                      type="button"
        ...
        <div className="rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-emerald-500/10 to-cyan-500/5 p-5 space-y-4">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-5 space-y-3">
          ...
          <div className="space-y-2">
            {[
              ...
              { label: "Add to Pools", pts: REWARDS.addLiquidity, page: "liquidity" as NavPage },
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] text-sm"
              >
                <span>{m.label}</span>
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-5">
          ...
          {board.length === 0 ? (
            <p className="text-xs text-[var(--text-muted)]">
              Check in or save a name to appear here.
            </p>
          ) : (
            board.map((row, i) => (
              <div
